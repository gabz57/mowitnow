 ...
 * <p>
 * Note: the lawn is excluded from equality check, as it references the parent object
 *
 * @author Arnaud
 */
@Data
...
public class Mower {
     ...
     * @param initialPosition the initial position of the mower on the lawn, must be inside
     ...
     * the limits of the lawn.
     *
     * @param movement the movement to process
     */
     ...
     *
     * @param nextCoordinate the next coordinate of the mower
     ...
     * mower.
     *
     * @param rotation the rotation to process
     */
